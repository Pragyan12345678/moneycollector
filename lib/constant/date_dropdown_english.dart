        ...
        return Consumer<ThemeModel>(builder: (context, theme, child) {
          return Column(
            children: [
                    ...
                    child: CustomDropdownButton(
                      ...
                      onChanged: (selected) {
                        setState(() {
                          ...
                          dateState.month = selectedMonth!.id;
              ...
              Text(
                "${DateTime(selectedYear, selectedMonthId, selectedDay).toNepaliDateTime().year} - ${DateTime(selectedYear, selectedMonthId, selectedDay).toNepaliDateTime().month} - ${DateTime(selectedYear, selectedMonthId, selectedDay).toNepaliDateTime().day} BS",
                style: TextStyle(
