...
class EntryLoan extends StatefulWidget {
  
  const EntryLoan({super.key});

  @override
  State<EntryLoan> createState() => _EntryLoanState();
}

class _EntryLoanState extends State<EntryLoan> {
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            flex: 6,
                            child: Text(
                              "Loan Entry", // Correcting string interpolation
                              style: TextStyle(
                                fontSize: 18.sp,
                                color: Colors.white,
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                Row(
                                  ...
                                  loanacc.accountLoanCollections.isEmpty
                    ? const Nodata()
                    : Column(
                        children: [
                          AccountTableHeader(),
                          SizedBox(height: 460.h, child: LoanData()),
                        ],
                      ),
                                ],
                              ),
